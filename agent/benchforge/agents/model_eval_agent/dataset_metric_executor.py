...
from benchforge.evaluation.dataset_metrics.diversity_score import DiversityScoreMetric
from benchforge.evaluation.dataset_metrics.registry import DATASET_METRIC_REGISTRY
