...
from pipelines.chunk import ChunkSamplingConfig, sample_chunks
from utils.model import Model
from settings import PROMPTS_DIR, UTILS_DIR
...
if __name__ == "__main__":
    path = UTILS_DIR / "document.json"
    data = read_file(path)
    system_prompt = read_file(PROMPTS_DIR / "single_shot_system_prompt.md")
    user_prompt = read_file(PROMPTS_DIR / "single_shot_user_prompt.md")
    ...
    for pmt in prompts:
        ...
        print("AAAA\n")
    with open(UTILS_DIR / "chunk_ques.json", "w",encoding='utf8') as f:
