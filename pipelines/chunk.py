...
if __name__ == "__main__":
    ...
    input_path = UTILS_DIR / "a.txt"
    output_path = UTILS_DIR / "b.json"
    ...
    h_max = 5
    multihops_factor = 2
    doc = {"document_text": [paragraph], "doc_id": f"doc_{abs(hash(paragraph)) % 10000}"}
    chunks, multihops = _process_document(model_name,doc,max_tokens,h_min,h_max,multihops_factor)
