...
class QuestionRow(BaseModel):
    key_point: str      # Summarize the core knowledge examined by the question.
...
[
  {
    "key_point": "Analyzing the impact of semantic chunking through fault hypothesis.",
  ...
  {
    "key_point": "Applying chunking techniques and balancing chunk size with coherence.",
  ...
  {
    "key_point": "Understanding Constraints on semantic chunking.",
  ...
  {
    "key_point": "Analyzing the impact of semantic chunking by assuming missing chunks.",
  ...
  {
    "key_point": "Understanding the concept of semantic chunking through identifying a flawed premise.",
...
- Always provide `key_point` that summarize the core knowledge examined by the question.
